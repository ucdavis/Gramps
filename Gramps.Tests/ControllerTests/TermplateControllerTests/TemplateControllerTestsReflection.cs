...
namespace Gramps.Tests.ControllerTests.TermplateControllerTests
{
    public partial class TemplateControllerTests
    {
        ...
        public void TestControllerMethodCreatePostContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = _controllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "Create").ToList();
            #endregion Arrange
        ...
        public void TestControllerMethodEditPostContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = _controllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "Edit").ToList();
            #endregion Arrange

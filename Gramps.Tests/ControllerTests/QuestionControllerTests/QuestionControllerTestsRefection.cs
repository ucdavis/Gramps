...
namespace Gramps.Tests.ControllerTests.QuestionControllerTests
{
    public partial class QuestionControllerTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodMoveUpContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = ControllerClass;
            var controllerMethod = controllerClass.GetMethod("MoveUp");
            #endregion Arrange
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodMoveDownContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = ControllerClass;
            var controllerMethod = controllerClass.GetMethod("MoveDown");
            #endregion Arrange

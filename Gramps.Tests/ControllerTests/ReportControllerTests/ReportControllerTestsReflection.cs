...
namespace Gramps.Tests.ControllerTests.ReportControllerTests
{
    public partial class ReportControllerTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodCallIndexContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = ControllerClass;
            var controllerMethod = controllerClass.GetMethod("CallIndex");
            #endregion Arrange
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodCreateForTemplateGetContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = ControllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "CreateForTemplate");
            #endregion Arrange
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodCreateForTemplatePostContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = ControllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "CreateForTemplate");
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodEditForTemplateGetContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = ControllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "EditForTemplate");
            #endregion Arrange
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodEditForTemplatePostContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = ControllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "EditForTemplate");
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodEditForCallGetContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = ControllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "EditForCall");
            #endregion Arrange
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodEditForCallPostContainsExpectedAttributes()
        {
            #region Arrange
            var controllerClass = ControllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "EditForCall");

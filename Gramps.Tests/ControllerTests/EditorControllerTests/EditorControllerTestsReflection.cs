...
namespace Gramps.Tests.ControllerTests.EditorControllerTests
{
    public partial class EditorControllerTests
    {
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodEditReviewerContainsExpectedAttributes1()
        {
            #region Arrange
            var controllerClass = _controllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "EditReviewer");
            #endregion Arrange
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodEditReviewerContainsExpectedAttributes2()
        {
            #region Arrange
            var controllerClass = _controllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "EditReviewer");
        ...
        public void TestControllerMethodSendCallContainsExpectedAttributes1()
        {
            #region Arrange
            var controllerClass = _controllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "SendCall");
            #endregion Arrange
        ...
        /// </summary>
        [TestMethod]
        public void TestControllerMethodSendCallgetContainsExpectedAttributes2()
        {
            #region Arrange
            var controllerClass = _controllerClass;
            var controllerMethod = controllerClass.GetMethods().Where(a => a.Name == "SendCall");

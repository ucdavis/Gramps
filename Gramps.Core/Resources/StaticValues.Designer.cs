...
namespace Gramps.Core.Resources {
    ...
    public class StaticValues {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Call For Proposal is not active or end date has passed. {0}..
        /// </summary>
        public static string Message_ProposalNotActive {
            get {
                return ResourceManager.GetString("Message_ProposalNotActive", resourceCulture);
            }
        }
        ...
        public static string Message_ProposalSubmitted {
            get {
                return ResourceManager.GetString("Message_ProposalSubmitted", resourceCulture);
            }
        }
